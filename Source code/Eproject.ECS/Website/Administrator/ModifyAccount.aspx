                                        ...
                                        <asp:Panel ID="pnlPreview" runat="server">
                                            ...
                                            <div id="related-activities">
                                                ...
                                                <div id="related-act-top">
                                                    <img src="<%=ResolveUrl("~")%>App_Themes/images/forms/header_personal_act.gif" width="271"
                                                        height="43" alt="" />
                                                </div>
                                                <!-- end related-act-top -->
                                                ...
                                                <div id="related-act-bottom">
                                                    ...
                                                    <div id="related-act-inner">
                                                        <div style="text-align: center">
                                                            <asp:ImageButton ID="imgAvatar" runat="server" CausesValidation="False" ImageUrl="~/App_Themes/images/other/no_image.png" /></div>
                                                        <div class="clear">
                                                        </div>
                                                        ...
                                                        <div class="right">
                                                            ...
                                                            <ul class="greyarrow">
                                                                <li>
                                                                    <asp:HyperLink ID="hplnkModifyProfile" runat="server">Click here modify profile</asp:HyperLink></li>
                                                            </ul>
                                                        </div>
                                                        <div class="clear">
                                                        </div>
                                                        ...
                                                        <div class="right">
                                                            ...
                                                            <ul class="greyarrow">
                                                                <li>
                                                                    <asp:HyperLink ID="hplnkModifyDepartment" runat="server">Click here modify department</asp:HyperLink></li>
                                                            </ul>
                                                        </div>
                                                        <div class="clear">
                                                        </div>
