<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CreateDepartment.aspx.cs" Inherits="HRManager_CreateDepartment" Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Excell-on Consulting Services</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" Runat="Server">
<div id="page-heading"><h1>CREATE DEPARTMENT</h1></div>
	    ...
	    <!--  start content-table-inner -->
	            ...
	            <td>
		            ...
		            <div id="step-holder">
			            ...
			            <div class="step-dark-left"><a href="<%=ResolveUrl("~")%>ManageSystem/Department/Create">
