<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ManageDepartment.aspx.cs" Inherits="HRManager_ManageDepartment" Title="Excell-on Consulting Services"
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
    <div id="page-heading">
        <h1>
            MANAGE DEPARTMENT INFORMATION</h1>
    </div>
                                                            ...
                                                            <asp:TemplateField HeaderText="&lt;a href&gt;Option&lt;/a&gt;">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ID="imgbtnRemove" runat="server" CssClass="confirm" ImageUrl="~/App_Themes/images/table/table_icon_remove.gif"
                                                                        CausesValidation="False" ToolTip="Remove department" OnClick="imgbtnRemove_Click" />
                                                                    <asp:HiddenField ID="hfDepartmentId" runat="server" Value='<%# Eval("Department_Id") %>' />
                                                                    <asp:ImageButton ID="imgbtnEditDepartment" runat="server" PostBackUrl='<%# GetDepartmentModifyURL(Eval("Department_Id")) %>'
                                                                        ImageUrl="~/App_Themes/images/table/table_icon_edit.gif" CausesValidation="False"
                                                                        ToolTip="Edit department" onclick="imgbtnEditDepartment_Click" />
                                                                </ItemTemplate>
                                                                <AlternatingItemTemplate>
                                                                    <asp:ImageButton ID="imgbtnRemove" runat="server" CssClass="confirm" ImageUrl="~/App_Themes/images/table/table_icon_remove.gif"
                                                                        CausesValidation="False" ToolTip="Remove department" OnClick="imgbtnRemove_Click" />
