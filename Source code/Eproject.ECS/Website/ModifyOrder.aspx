<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ModifyOrder.aspx.cs" Inherits="ServiceEmployee_ModifyOrder" Title="Excell-on Consulting Services"
    ValidateRequest="false" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" Runat="Server">
    <div id="page-heading"><h1>MODIFY ORDER INFORMATION</h1></div>
	    ...
	    <!--  start content-table-inner -->
	            ...
	            <td>
		            ...
		            <div id="step-holder">
			            ...
			            <div class="step-dark-left"><a href="<%=ResolveUrl("~")%>ManageService/Order/Modify">
                ...
                <ContentTemplate>
                    ...
                    <asp:Wizard ID="wizardCreate" runat="server" ActiveStepIndex="0" Width="100%"
                            ...
                            DisplayCancelButton="True" oncancelbuttonclick="wizardCreate_CancelButtonClick">
