<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="CreateProblem.aspx.cs" Inherits="ServiceEmployee_CreateProblem" Title="Untitled Page" %>
                            ...
                            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                <tr valign="top">
                                    <td>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" id="id-form">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlCustomer" runat="server" CssClass="styledselect_form" OnSelectedIndexChanged="ddlCustomer_SelectedIndexChanged"
                                                        AutoPostBack="True">
                                                    </asp:DropDownList>
                                                </td>
                                                <td>
                                    ...
                                    <td>
                                        ...
                                        <%--<asp:Panel ID="pnlPreviewCompany" runat="server" Visible="false">
                                            <!--  start related-activities -->
                                            <div id="Div1">
                                                <!--  start related-act-top -->
                                                <div id="Div2">
