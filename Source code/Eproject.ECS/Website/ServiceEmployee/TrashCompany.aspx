<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TrashCompany.aspx.cs" Inherits="ServiceEmployee_TrashCompany" Title="Untitled Page" %>
                                            ...
                                            <tr>
                                                <td colspan="2" align="center">
                                                    <asp:GridView ID="grvManage" runat="server" AutoGenerateColumns="False" CssClass="product-table"
                                                        Width="95%" AllowPaging="True" PageSize="5" 
                                                        onrowdeleting="grvManage_RowDeleting" 
                                                        onselectedindexchanging="grvManage_SelectedIndexChanging">
                                                        <Columns>
