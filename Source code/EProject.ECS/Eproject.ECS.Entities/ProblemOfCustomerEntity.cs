...
{
    public class ProblemOfCustomerEntity
    {
        ...
        /// 
        /// </summary>
         public ProblemOfCustomerEntity()
         {
         }
        ...
        public ProblemOfCustomerEntity(string problemOfCustomerId, string customerId, string companyId, string problemId, DateTime problemOfCustomerDate, bool problemOfCustomerIsDelete)
        {
