...
namespace Eproject.ECS.Entities
{
    public class ContactEntity
    {
        ...
        public ContactEntity(string contactId, string contactTitle, string contactContent, string contactName, string contactEmail, DateTime contactDate, int contactStatus, bool contactIsDelete)
        {
