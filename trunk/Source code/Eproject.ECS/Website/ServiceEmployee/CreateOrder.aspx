<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="CreateOrder.aspx.cs" Inherits="ServiceEmployee_CreateOrder" Title="Excell-on Consulting Services"
                            ...
                            <td>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <!--  end message-green -->
                                        <!-- start id-form -->
                                        <asp:Wizard ID="wizardCreate" runat="server" ActiveStepIndex="0" Width="100%" SkipLinkText=""
                                            DisplaySideBar="False" EnableTheming="True" OnActiveStepChanged="wizardCreate_ActiveStepChanged"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" id="id-form">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <br />
                                                                <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="ddlCompanyName"
                                                                    Display="Dynamic" CssClass="content" Font-Size="12px" ErrorMessage="You must select a company to create new order."
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <br />
                                                                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="ddlAccount"
                                                                    Display="Dynamic" CssClass="content" Font-Size="12px" ErrorMessage="You must select an account of employee to create new order."
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <br />
                                                                <asp:CompareValidator ID="CompareValidator6" runat="server" ControlToValidate="ddlPaymentMethod"
                                                                    Display="Dynamic" CssClass="content" Font-Size="12px" ErrorMessage="You must select method to pay for new order."
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtBillDate" runat="server" CssClass="inp-form datePickerService"></asp:TextBox>
                                                                <br />
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtBillDate"
                                                                    Display="Dynamic" CssClass="content" Font-Size="12px" ErrorMessage="Bill date is required."></asp:RequiredFieldValidator>
                                                                <asp:CompareValidator ID="cvBillDate" runat="server" ControlToValidate="txtBillDate"
                                                                    Display="Dynamic" CssClass="content" Font-Size="12px" ErrorMessage="Your bill date is invalid."
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtPaymentDate" runat="server" CssClass="inp-form datePickerService"></asp:TextBox>
                                                                <br />
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtPaymentDate"
                                                                    Display="Dynamic" CssClass="content" Font-Size="12px" ErrorMessage="Payment date is required."></asp:RequiredFieldValidator>
                                                                <asp:CompareValidator ID="cvPaymentDate" runat="server" ControlToValidate="txtPaymentDate"
                                                                    Display="Dynamic" CssClass="content" Font-Size="12px" ErrorMessage="Your payment date is greater than or equal bill date."
                                                                    Operator="GreaterThanEqual" Type="Date" ControlToCompare="txtBillDate"></asp:CompareValidator>
                                                            </td>
                                                            <td>
                                                            </td>
                                                        </tr>
                                                                        ...
                                                                        <td valign="top">
                                                                            <table border="0" cellpadding="0" cellspacing="0" id="id-form">
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="inp-form">
                                                                                            <asp:DropDownList ID="ddlService" runat="server" AutoPostBack="True" CssClass="styledselect_form"
                                                                                                OnSelectedIndexChanged="ddlService_SelectedIndexChanged" ValidationGroup="grvService">
                                                                                            </asp:DropDownList>
                                                                                        </div>
                                                                                        <br />
                                                                                        <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="ddlService"
                                                                                            Display="Dynamic" CssClass="content" Font-Size="12px" ErrorMessage="You must select  service to create new order."
                                                                                            ValidationGroup="grvService" Operator="NotEqual" ValueToCompare="Select service"></asp:CompareValidator>
                                                                                    </td>
                                                                                    <td>
                                                                                        &nbsp;
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtFromDate" runat="server" CssClass="inp-form datePickerService"
                                                                                            ValidationGroup="grvService"></asp:TextBox>
                                                                                        <br />
                                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ValidationGroup="grvService"
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtToDate" runat="server" CssClass="inp-form datePickerService"></asp:TextBox>
                                                                                        <br />
                                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="grvService"
                                                                                        ...
                                                                                        <asp:CompareValidator ID="cvToDate" runat="server" ValidationGroup="grvService" ControlToValidate="txtToDate"
                                                                                            Display="Dynamic" CssClass="content" Font-Size="12px" ErrorMessage="Your date is greater than or equal from date."
                                                                                            Operator="GreaterThanEqual" Type="Date" ControlToCompare="txtFromDate"></asp:CompareValidator>
                                                                                    </td>
                                                                                    <td>
                                                                                        &nbsp;
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtNumberEmployee" runat="server" CssClass="inp-form" ValidationGroup="grvService"></asp:TextBox>
                                                                                        <br />
                                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ValidationGroup="grvService"
                                                                                        ...
                                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtNumberEmployee"
                                                                                            Display="Dynamic" CssClass="content" Font-Size="12px" ValidationExpression="\d+"
                                                                                            ValidationGroup="grvService" ErrorMessage="Format of input is invalid. A number is required."></asp:RegularExpressionValidator>
                                                                                        <asp:CompareValidator ID="CompareValidator4" runat="server" ErrorMessage="Number of employees is invalid."
                                                                                            Display="Dynamic" CssClass="content" Font-Size="12px" ControlToValidate="txtNumberEmployee"
                                                                                            Operator="GreaterThan" Type="Integer" ValueToCompare="0" ValidationGroup="grvService"></asp:CompareValidator>
                                                                                    </td>
                                                                                    <td>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Button ID="btnAdd" runat="server" CssClass="form-add" OnClick="btnAdd_Click"
                                                                                            ValidationGroup="grvService" />
                                                                                        <asp:Button ID="btnRemove" runat="server" CausesValidation="False" Visible="False"
                                                                                            OnClick="btnRemove_Click" CssClass="form-remove" />
                                                                                        <br />
                                                                                    </td>
                                                                                    <td>
                                                                                    </td>
                                                                            ...
                                                                            <asp:GridView ID="grvManage" runat="server" AutoGenerateColumns="False" CssClass="product-table"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="&lt;a href&gt;Name&lt;/a&gt;" SortExpression="Service_Name">
                                                                                        <AlternatingItemTemplate>
                                                                                            <asp:Label ID="lblName" runat="server" Text='<%# Eval("Service_Name") %>'></asp:Label>
                                                                                        </AlternatingItemTemplate>
                                                                                        <ItemTemplate>
                                                                                            <asp:Label ID="lblName" runat="server" Text='<%# Eval("Service_Name") %>'></asp:Label>
                                                                                        </ItemTemplate>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="&lt;a href&gt;Remove&lt;/a&gt;" ShowHeader="False">
                                                                                        <AlternatingItemTemplate>
                                                                                            <asp:ImageButton ID="imgbtnRemove" runat="server" CausesValidation="False" ImageUrl="~/App_Themes/images/forms/form_remove.gif"
                                                                ...
                                                                <asp:Panel ID="pnlInfo" Visible="False" runat="server">
                                                                    ...
                                                                    <div id="related-activities">
                                                                        ...
                                                                        <div id="related-act-top">
                                                                            <img src="<%=ResolveUrl("~")%>App_Themes/images/forms/header_related_act.gif" width="271"
                                                                                height="43" alt="" />
                                                                        </div>
                                                                        <!-- end related-act-top -->
                                                                        ...
                                                                        <div id="related-act-bottom">
                                                                            ...
                                                                            <div id="related-act-inner">
                                                                                <div style="text-align: center">
                                                                                    <asp:Image ID="imgAvatar" runat="server" CausesValidation="False" ImageUrl="~/App_Themes/images/other/no_image.png" /></div>
                                                                                <div class="clear">
                                                                                </div>
                                                                            ...
                                                                            <div style="background: #ECECEC">
                                                                                <table border="0" align="center" cellpadding="2" cellspacing="2" width="100%">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td colspan="3">
                                                                                            ...
                                                                                            <p class="content" style="font-size: 12px">
                                                                                                - Infomation of the comapany that you choose.</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:Label ID="lblPreviewPhone" CssClass="content" runat="server"></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <th align="right" style="text-align: right;" class="content" valign="top">
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:Label ID="lblPreviewEmail" CssClass="content" runat="server"></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <th align="right" style="text-align: right;" class="content" valign="top">
                                                                                        ...
                                                                                        <td align="left" valign="top">
                                                                                            <asp:Label ID="lblPreviewAddress" CssClass="content" runat="server"></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <th align="right" style="text-align: right;" class="content" valign="top">
                                                                                        ...
                                                                                        <td align="left" valign="top">
                                                                                            <asp:Label ID="lblPreviewDescription" CssClass="content" runat="server"></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="center" colspan="3" class="content">
                                                                                            <asp:Button ID="btnChangeCompany" runat="server" CssClass="form-change" Text="Change Company"
                                                                                ...
                                                                                <table border="0" align="center" cellpadding="2" cellspacing="2" width="100%">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td colspan="3">
                                                                                            ...
                                                                                            <br />
                                                                                            <p class="content" style="font-size: 12px">
                                                                                                - Infomation of the employee who makes bill.</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:Label ID="lblPreviewAccount" CssClass="content" runat="server"></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <th align="right" style="text-align: right;" class="content" valign="top">
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:Label ID="lblPreviewEmployeeEmail" CssClass="content" runat="server"></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="center" class="content" colspan="3">
                                                                                            <asp:Button ID="btnChangeEmployee" runat="server" CssClass="form-change" OnClick="btnChangeEmployee_Click"
                                                                            ...
                                                                            <div style="background: #ECECEC">
                                                                                <table border="0" align="center" cellpadding="2" cellspacing="2" width="100%">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:Label ID="lblPaymentdate" CssClass="content" runat="server"></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <th align="right" style="text-align: right; width: 50%;" class="content" valign="top">
                                                                                        ...
                                                                                        <td align="left" valign="top">
                                                                                            <asp:Label ID="lblOrderDescription" CssClass="content" runat="server"></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <th class="content" valign="top" align="right" style="text-align: right; width: 50%;">
                                                                                            Total Services :
                                                                                        </th>
                                                                                        <td align="left">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="center" colspan="3" class="content">
                                                                                            <asp:Button ID="btnChangeOrder" runat="server" CssClass="form-change" OnClick="btnChangeOrder_Click"
                                                                                                Text="Change Order" />
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
