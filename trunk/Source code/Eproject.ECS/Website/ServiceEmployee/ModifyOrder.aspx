<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ModifyOrder.aspx.cs" Inherits="ServiceEmployee_ModifyOrder" Title="Excell-on Consulting Services"
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <asp:Wizard ID="wizardCreate" runat="server" ActiveStepIndex="0" Width="100%" SkipLinkText=""
                                            ...
                                            OnNextButtonClick="wizardCreate_NextButtonClick" OnFinishButtonClick="wizardCreate_FinishButtonClick"
                                            DisplayCancelButton="True" 
                                            OnCancelButtonClick="wizardCreate_CancelButtonClick">
                                                ...
                                                <asp:WizardStep ID="WizardCreateOrder" runat="server" Title="Create order">
                                                    <table border="0" cellpadding="0" cellspacing="0" id="id-form">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblCompanyName" CssClass="th-label" runat="server" Text=""></asp:Label>
                                                            </td>
                                                            <td>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblAccount" CssClass="th-label" runat="server" Text=""></asp:Label>
                                                            </td>
                                                            <td>
                                                            </td>
                                                        </tr>
                                                                        ...
                                                                        <td valign="top" align="center">
                                                                            <asp:GridView ID="grvManage" runat="server" AutoGenerateColumns="False" CssClass="product-table"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="&lt;a href&gt;Remove&lt;/a&gt;" 
                                                                                        ShowHeader="False">
                                                                                        <AlternatingItemTemplate>
                                                                                            <asp:ImageButton ID="imgbtnRemove" runat="server" CausesValidation="False" 
                                                                                                ImageUrl="~/App_Themes/images/forms/form_remove.gif" 
                                            ...
                                            <CancelButtonStyle CssClass="form-cancel" />
                                        </asp:Wizard>
                                        <!-- end id-form  -->
                                        </td>
                                        <td>
