<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TrashOrder.aspx.cs" Inherits="ServiceEmployee_TrashOrder" Title="Excell-on Consulting Services"
                                                            ...
                                                            <asp:TemplateField HeaderText="&lt;a href&gt;Option&lt;/a&gt;">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ID="imgbtnDelete" runat="server" CssClass="confirmDelete" ImageUrl="~/App_Themes/images/table/table_icon_delete.gif"
                                                                        CausesValidation="False" ToolTip="Delete order permanently" OnClick="imgbtnDelete_Click" />
                                                                    ...
                                                                    <asp:ImageButton ID="imgbtnRestore" runat="server" CssClass="confirmRestore" ImageUrl="~/App_Themes/images/table/table_icon_restore.gif"
                                                                        CausesValidation="False" ToolTip="Restore order" OnClick="imgbtnRestore_Click" />
                                                                </ItemTemplate>
                                                                <AlternatingItemTemplate>
                                                                    <asp:ImageButton ID="imgbtnDelete" runat="server" CssClass="confirmDelete" ImageUrl="~/App_Themes/images/table/table_icon_delete.gif"
                                                                        CausesValidation="False" ToolTip="Delete order permanently" OnClick="imgbtnDelete_Click" />
