...
public partial class MyAccount : System.Web.UI.Page
{
    ...
    protected void btnChangeName_Click(object sender, EventArgs e)
    {
        if (IsValid)
        {
            try
            {
                EB.UpdateEmployee(account.Account_UserName, txtFirstName.Text.Trim(), txtLastName.Text.Trim(), null, null, null, null, null, null);
    ...
    protected void btnChangeEmail_Click(object sender, EventArgs e)
    {
        if (IsValid)
        {
            ...
            try
            {
                EB.UpdateEmployee(account.Account_UserName, null, null, txtEmail.Text.Trim(), txtAddress.Text.Trim(), txtPhoneNumber.Text.Trim(), null, null, null);
        ...
        if (IsValid)
        {
            try
            {
                ...
                if (!gender.Equals(radGender.Text.Trim()))
                {
                    ...
                    EB.UpdateEmployee(account.Account_UserName, null, null, null, null, null, radGender.Text.Trim(), null, data);
    ...
    protected void btnChangeBirthday_Click(object sender, EventArgs e)
    {
        try
        {
            if (IsValid)
            {
                EB.UpdateEmployee(account.Account_UserName, null, null, null, null, null, null,txtBirthday.Text.Trim(), null);
        ...
        if (IsValid)
        {
            try
            {
                if (fuAvatar.HasFile)
                {
                    ...
                    EB.UpdateEmployee(account.Account_UserName, null, null, null, null, null, null, null, data);
