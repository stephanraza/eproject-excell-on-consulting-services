<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="CreateService.aspx.cs" Inherits="ServiceManager_CreateService" Title="Excell-on Consulting Services" %>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" id="id-form">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <br />
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtCharge"
                                                        Display="Dynamic" CssClass="content" Font-Size="12px" ErrorMessage="Charge of service is required."></asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" CssClass="content"
