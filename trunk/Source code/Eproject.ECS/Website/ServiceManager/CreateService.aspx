<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CreateService.aspx.cs" Inherits="ServiceManager_CreateService" Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Excell-on Consulting Services</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" Runat="Server">
<div id="page-heading"><h1>CREATE SERVICES</h1></div>
	    ...
	    <!--  start content-table-inner -->
	            ...
	            <td>
		            ...
		            <div id="step-holder">
			            ...
			            <div class="step-dark-left"><a href="<%=ResolveUrl("~")%>ManageService/Service/Create">
                            Create details</a></div>
			            <div class="step-dark-right">&nbsp;</div>
			            <div class="step-no-off">2</div>
			            <div class="step-light-left"><a href="<%=ResolveUrl("~")%>ManageService/Service/Manage">
                            Manage services</a></div>
			            <div class="step-light-right">&nbsp;</div>
			            <div class="step-no-off">3</div>
			            <div class="step-light-left"><a href="<%=ResolveUrl("~")%>ManageService/Service/Modify">
                            Modify details</a></div>
			            <div class="step-light-right">&nbsp;</div>
			            <div class="step-no-off">4</div>
			            <div class="step-light-left"><a href="<%=ResolveUrl("~")%>ManageService/Service/Trash">
                            Trash</a></div>
		            ...
		            <!-- start id-form -->   
		                    ...
		                    <tr>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                    ControlToValidate="txtName" Display="Dynamic" CssClass="content" Font-Size="12px"
                                    ErrorMessage="Name of service is required."></asp:RequiredFieldValidator>
                                </td>
			                    <td>&nbsp;</td>
		                    </tr>
		                    <tr>
		                    ...
		                    <tr>
			                    <th valign="top">Service Charge :</th>
			                    <td>
                                    <asp:TextBox ID="txtCharge" runat="server" CssClass="charge-form"></asp:TextBox>
                                    <br />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                    ControlToValidate="txtCharge" Display="Dynamic" CssClass="content" Font-Size="12px"
                                    ErrorMessage="Charge of service is required."></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                                        CssClass="content" Font-Size="12px"
                                        ErrorMessage="Format of the charge is invalid." ControlToValidate="txtCharge" 
		                    ...
		                    <td>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                                    ControlToValidate="fileuploadImage" Display="Dynamic" CssClass="content" Font-Size="12px"
