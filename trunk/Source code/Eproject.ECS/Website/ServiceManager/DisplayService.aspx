<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="DisplayService.aspx.cs" Inherits="ServiceManager_DisplayService" Title="Excell-on Consulting Services" %>
                                                    ...
                                                    <div style="padding: 5px; border: solid 1px #CCC;">
                                                        <div style="background: #ECECEC">
                                                            <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
                                                                ...
                                                                <tr>
                                                                    <td style="width: 100px" align="center" valign="top" rowspan="5">
                                                                ...
                                                                <tr>
                                                                    <th align="right" style="text-align: right" class="content" valign="top">
                                                                        Number Of Companies Use Service :
                                                                    </th>
                                                                    <td align="left" valign="top">
                                                                    ...
                                                                    <asp:Panel ID="pnlLink" runat="server">
                                                                        ...
                                                                        <td colspan="3">
                                                                            <div style="float: left">
                                                                                <ul class="greyarrow">
                                                                                    <li>
                                                                                        <asp:HyperLink ID="hplnkDisplayModifyService" runat="server" Text="Click here modify service"></asp:HyperLink></li>
                                                                                </ul>
                                                                            </div>
                                                                        </td>
                                                                    </asp:Panel>
