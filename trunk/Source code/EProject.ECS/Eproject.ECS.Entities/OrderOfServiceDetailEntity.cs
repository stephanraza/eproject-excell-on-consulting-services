...
{
    public class OrderOfServiceDetailEntity
    {
        ...
        /// 
        /// </summary>
         public OrderOfServiceDetailEntity()
         {
         }
        ...
        public OrderOfServiceDetailEntity(string orderServiceId, string serviveId, DateTime orderServiceDetailFromDate, DateTime orderServiceDetailToDate, int orderServiceDetailNumberOfEmployee, string orderServiceDetailPrice, bool orderServiceDetailIsDelete)
        {
