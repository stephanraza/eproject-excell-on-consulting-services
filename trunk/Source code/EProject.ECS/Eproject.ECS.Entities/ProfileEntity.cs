...
namespace Eproject.ECS.Entities
{
    public class ProfileEntity
    {
        ...
        public ProfileEntity(string profileId, string employeeId, string profileFirtName, string profileLastName, bool profileGender, DateTime profileDateOfBirth, string profileAddress, string profilePhoneNumber, string profileEmail, string profileAvatar, bool profileIsDelete)
        {
