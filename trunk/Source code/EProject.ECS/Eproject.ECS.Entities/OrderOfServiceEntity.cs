...
{
    public class OrderOfServiceEntity
    {
        ...
        public OrderOfServiceEntity(string orderOfServiceId, string companyId, string employeeId, int orderServiceTotalServices, string orderServiceTotalCharges, string orderServiceDescription, string orderServicePaymentMethod, DateTime orderServicePaymentDate, DateTime orderServiceBillDate, int orderServiceStatus, bool orderServiceIsDelete)
        {
