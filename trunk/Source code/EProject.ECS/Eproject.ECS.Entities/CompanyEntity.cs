...
namespace Eproject.ECS.Entities
{
    public class CompanyEntity
    {
        ...
        public CompanyEntity(string companyId, string companyName, string companyLogo, string companyDescription, string companyPhone, string companyEmail, string companyAddress, bool companyIsDelete)
        {
