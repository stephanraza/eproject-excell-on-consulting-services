...
namespace Eproject.ECS.Entities
{
    public class ProductEntity
    {
        ...
        public ProductEntity(string productId, string companyId, string categoryId, string productName, string productPrice, string productDescription, string productImage, DateTime productManufactureDate, DateTime productExpiryDate, bool ppoductIsDelete)
        {
